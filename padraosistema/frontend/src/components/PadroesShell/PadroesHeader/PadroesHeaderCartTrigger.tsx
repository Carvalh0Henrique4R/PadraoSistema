...
export const PadroesHeaderCartTrigger: React.FC = () => {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="relative flex shrink-0 items-center justify-center rounded-lg border border-white/15 bg-slate-900/80 p-2 text-slate-200 hover:border-indigo-500/40 hover:bg-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400/80"
